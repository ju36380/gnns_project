...
function fn_createBtn(){
	let buttonHtml ="";
	buttonHtml += "<a href='/pds/pdsList?page="+$('#page').val()+"&searchType="+$('#searchType').val()+"&keyword="+$('#keyword').val()+"' class='btn_type_01 gray list'>목록</a>";
...
function fn_pdsList(){
	...
	let page  = $("#page").val();
	frm.action="/pds/pdsList?page="+page+"&searchType="+searchType+"&keyword="+keyword;
	frm.submit();
}
