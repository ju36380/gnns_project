    ...
    let listHtml="";
        ...
        if(data.length>0){
            for(let i=0; i<data.length; i++){
                ...
                if(data[i].reLevel>0){
                    listHtml += "<li class='col_title'><a href='/safety/safetyAdminView?boardSeq="+data[i].boardSeq+"&searchType="+arg2+"&keyword="+arg3+"&page="+arg4+"' class='txt_01 reple'>"+data[i].subject+"</a></li>";
                }else{
                    listHtml += "<li class='col_title'><a href='/safety/safetyAdminView?boardSeq="+data[i].boardSeq+"&searchType="+arg2+"&keyword="+arg3+"&page="+arg4+"' class='txt_01'>"+data[i].subject+"</a></li>";
                }
                ...
                if(data[i].exeType=="" || data[i].exeType==null){
                    ...
                    listHtml += "<li class='col_file'><a href='/file/download?filePath=safety&fileSeq="+data[i].boardSeq+"' class='ico_down "+exeType+"'></a></li>"
                }
