...
function fn_noticeRegist(){
	let frm = document.frm;
	if(!fn_noticeVaildaitonCheck()) return false;
	fn_lastFileDel(); // 2021-11-18 준혁(추가)
	frm.submit(); 
}

function fn_noticeVaildaitonCheck(){
...
function uploadFile(obj){
	...
	formData.append("filePath", "notice");
...
function fn_deleteFile(){  // 2021-11-18 준혁(추가)
	...
	formData.append("seq", $("#notiSeq").val());
