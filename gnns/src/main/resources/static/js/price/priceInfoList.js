...
function fn_getPriceInfoListCallBack(data, page){
    ...
    if(data.length>0){
        ...
        for(let i=startRow; i<startRow+loopCnt; i++){
            resultHtml += '<tr>';
            resultHtml += '<td class="tc"><p class="txt_01">'+data[i].itemName+'</p></td>'
            resultHtml += '<td class="tc"><p class="txt_01">'+data[i].breedName+'</p></td>'
            resultHtml += '<td class="tr"><p class="txt_01">'+parseFloat(Number(data[i].unitQty).toFixed(2))+'</p></td>'
            resultHtml += '<td class="tr"><p class="txt_01">'+data[i].unit+'</p></td>'
            resultHtml += '<td class="tr"><p class="txt_01">'+data[i].grade+'</p></td>'
            resultHtml += '<td class="tr"><p class="txt_01">'+comma(data[i].lowPrice)+'</p></td>'
            resultHtml += '<td class="tr"><p class="txt_01">'+comma(data[i].maxPrice)+'</p></td>'
            resultHtml += '<td class="tr"><p class="txt_01">'+comma(data[i].avgPrice)+'</p></td>'
            resultHtml += '</tr>';
        }
    }else{
        resultHtml += '<tr>';
