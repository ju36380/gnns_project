...
function fn_createBtn(){
	let buttonHtml ="";
	buttonHtml += "<a href='/board/boardReply?boardSeq="+$('#boardSeq').val()+"&page="+$('#page').val()+"&searchType="+$('#searchType').val()+"&keyword="+$('#keyword').val()+"' class='btn_type_01 gray list'>답변</a>";
	buttonHtml += "&nbsp;";
	buttonHtml += "<a href='/board/boardList?page="+$('#page').val()+"&searchType="+$('#searchType').val()+"&keyword="+$('#keyword').val()+"' class='btn_type_01 gray list'>목록</a>";
...
function fn_boardList(){
	...
	let page  = $("#page").val();
	frm.action="/board/boardList?page="+page+"&searchType="+searchType+"&keyword="+keyword;
	frm.submit();
}
